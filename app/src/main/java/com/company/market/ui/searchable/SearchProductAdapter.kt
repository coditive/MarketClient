...
class SearchProductAdapter(private val clickHandler: SearchActivity.ClickHandler) :
    androidx.recyclerview.widget.ListAdapter<Product, SearchProductAdapter.CompactViewHolder>(
        CALLBACK
    ) {
